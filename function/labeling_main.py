...
from labeling.libs.combobox import ComboBox
from labeling.libs.default_label_combobox import DefaultLabelComboBox
from labeling.libs.resources import *
from labeling.libs.constants import *
from labeling.libs.utils import *
from labeling.libs.settings import Settings
from labeling.libs.shape import Shape, DEFAULT_LINE_COLOR, DEFAULT_FILL_COLOR
...
from labeling.libs.lightWidget import LightWidget
...
from labeling.libs.pascal_voc_io import PascalVocReader
from labeling.libs.pascal_voc_io import XML_EXT
from labeling.libs.yolo_io import YoloReader
from labeling.libs.yolo_io import TXT_EXT
from labeling.libs.create_ml_io import CreateMLReader
from labeling.libs.create_ml_io import JSON_EXT
from labeling.libs.ustr import ustr
from labeling.libs.hashableQListWidgetItem import HashableQListWidgetItem

__appname__ = 'Labeling-插件'
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        save_format = action('&YOLO', self.change_format,
                      'Ctrl+Y', 'format_yolo', get_str('changeSaveFormat'), enabled=True)
    ...
    def show_info_dialog(self):
        from labeling.libs.__init__ import __version__
    ...
    def save_file(self, _value=False):
        if self.default_save_dir  != None and len(ustr(self.default_save_dir)):
            if self.file_path:
...
def get_main_app(_argvs=None):
    ...
    win = MainWindow(_argvs["TRAINPATH"], _argvs["PREDEFCLASS"], _argvs["LABELPATH"])
    return app, win


def lab_main(_argvs):
    '''construct main app and run it'''
    app, _win = get_main_app(_argvs)
    _win.show()
