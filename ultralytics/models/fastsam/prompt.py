...
from ultralytics.utils.patches import imread,imwrite,imshow
...
class FastSAMPrompt:
    ...
    def plot(self,
        ...
        # imwrite(os.path.join(save_path, result_name), cv2.cvtColor(img_array, cv2.COLOR_RGB2BGR))
        imwrite(os.path.join(save_path, result_name), cv2.cvtColor(img_array, cv2.COLOR_RGB2BGR))
